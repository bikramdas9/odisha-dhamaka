MENU_ITEMS = [
    {"id": 1, "name": "Dalma", "category": "curry", "price": 149, "veg": True,
     "desc": "Classic Odia lentil & vegetable curry slow-cooked with panch phoron", "emoji": "🍲", "bestseller": True},
    ...
    {"id": 4, "name": "Pakhala Bhata", "category": "rice", "price": 99, "veg": True,
     "desc": "Fermented rice soaked overnight, served with badi, saga, raw onion & pickle", "emoji": "🍚", "bestseller": False},
    ...
    {"id": 6, "name": "Dahi Bara Aloo Dum", "category": "snacks", "price": 89, "veg": True,
     "desc": "Soft urad dal fritters dunked in whisked yoghurt & spicy potato gravy", "emoji": "🫙", "bestseller": True},
    {"id": 7, "name": "Odia Thali", "category": "thali", "price": 249, "veg": True,
     "desc": "Complete meal: rice, dal, dalma, 2 sabji, chutney, papad & dessert", "emoji": "🥘", "bestseller": False},
    {"id": 8, "name": "Non-Veg Thali", "category": "thali", "price": 299, "veg": False,
     "desc": "Rice, fish curry, chicken/mutton, dal, sabji & sweet", "emoji": "🍱", "bestseller": False},
    {"id": 9, "name": "Macha Jhola", "category": "curry", "price": 199, "veg": False,
     "desc": "Everyday Odia fish curry in turmeric & panch phoron gravy", "emoji": "🐠", "bestseller": False},
    {"id": 10, "name": "Aloo Potala Rasa", "category": "curry", "price": 129, "veg": True,
     "desc": "Potato & pointed gourd in a light, tangy tomato gravy", "emoji": "🥔", "bestseller": False},
    {"id": 11, "name": "Mudhi Mixture", "category": "snacks", "price": 59, "veg": True,
     "desc": "Puffed rice tossed with onion, tomato, green chilli, mustard oil & spices", "emoji": "🫘", "bestseller": False},
